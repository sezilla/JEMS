...
<body>
   ...
   <style>
      ...
      .footer-logo img {
         ...
         display: block;
         transform: scale(2.3);
         /* Increase size without stretching */
         transform-origin: left center;
         /* Keep the scaling from the left side */
      }
