  ...
  <div class="app-modal" data-name="settings">
      <div class="app-modal-container">
          <div class="app-modal-card" data-name="settings" data-modal='0'>
              <form id="update-settings" action="{{ route('avatar_url_url.update') }}" enctype="multipart/form-data" method="POST">
                  @csrf
                  {{-- <div class="app-modal-header">Update your profile settings</div> --}}
                  <div class="app-modal-body">
                      {{-- Udate profile avatar_url_url --}}
                      <div class="avatar_url_url av-l upload-avatar_url_url-preview chatify-d-flex"
                      style="background-image: url('{{ Chatify::getUserWithavatar_url_url(Auth::user())->avatar_url_url }}');"
                      ></div>
                      <p class="upload-avatar_url_url-details"></p>
                      <label class="app-btn a-btn-primary update" style="background-color:{{$messengerColor}}">
                          Upload New
                          <input class="upload-avatar_url_url chatify-d-none" accept="image/*" name="avatar_url_url" type="file" />
                      </label>
                      {{-- Dark/Light Mode  --}}
                      <p class="divider"></p>
