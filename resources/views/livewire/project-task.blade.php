        ...
        <div>
            ...
            @if (!empty($cards))
                @foreach ($cards as $card)
                    @if (auth()->user()->hasRole('Coordinator') || auth()->user()->departments->contains('name', $card['card_name']))
                        <x-filament::section class="my-4">
                            ...
                            @if ($card['card_description'])
                                <div class="py-4">
                                    <p class="text-sm text-gray-500 dark:text-gray-400">{{ $card['card_description'] }}
                                    </p>
                                </div>
                            @endif
                                                                        ...
                                                                        <x-slot name="heading">
                                                                            <div class="flex items-center gap-2">
                                                                                <x-filament::icon
                                                                                    ...
                                                                                    class="w-6 h-6 text-pink-500" />
                                                                                <span
                                                                                    class="font-semibold text-lg">Edit
                                                                                    Checklist</span>
                                                                            </div>
                                                                        </x-slot>
